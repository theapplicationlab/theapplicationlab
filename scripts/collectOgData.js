...
const LOGO_PATH_IN_ASSETS = 'images/Aplab-logo.png';
...
const HOMEPAGE_TITLE = "The Application Lab";
const HOMEPAGE_DESCRIPTION = "The Application Lab is a peer-led mentorship and community initiative dedicated to supporting students from underrepresented and under-resourced backgrounds in navigating international university applications, with a primary focus on the UK.";
const SIZES = [
...
async function collectData() {
  ...
  const globalHash = createHash(Buffer.concat([templateBuffer, eventTemplateBuffer, youtubeTemplateBuffer, logoBuffer]));
